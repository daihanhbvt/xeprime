...
| Uy tín gian hàng | BA chỉ số công khai (tỉ lệ phản hồi · thời gian phản hồi · nhận-và-giữ chuyến), cửa sổ 90 ngày, dưới 5 mẫu thì `null` chứ không phải 0 — ADR 0045 điều 3. **Nguồn tính duy nhất là `HostMetricsService`**; sổ ví dùng cùng phép phân loại, chỉ đổi cửa sổ và ngưỡng |
