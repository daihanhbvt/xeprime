...
**Vì sao Wave 1A không sửa**: (a) là feature component có wave riêng và cổng QA riêng ([07 §7.3](07_VISUAL_QA_MATRIX.md)); (b) sửa làm **đổi hình ảnh lịch** mà wave này không QA thị giác được; (c) nhánh `maintenance` cần một bậc nền tím chưa có nguồn Figma → là quyết định thiết kế, không phải ánh xạ token.
