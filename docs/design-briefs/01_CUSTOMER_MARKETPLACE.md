...
> **Authoritative sources:** application source code and accepted ADRs. As-built docs in `docs/project/` are secondary.
>
...
`docs/project/04_API.md` · `05_PAGES.md` · `06_COMPONENTS.md` · `07_BUSINESS_RULES.md` · `09_DESIGN_PROBLEMS.md` · `10_MISSING_FEATURES.md`
