 ...
 *
 * Màn hình KHÔNG tự kiểm 401 — chúng chỉ đọc `useCurrentUser`, và route guard ở
 * `app/(app)/_layout.tsx` là nơi duy nhất điều hướng. Tách làm hai vì kho token nằm ngoài cây
 * React (không gọi được `useRouter`), còn guard thì không thấy vòng đời của token.
 */
