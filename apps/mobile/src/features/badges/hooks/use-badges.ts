 ...
 * observer. Ba nơi đọc (chuông, biểu tượng chat, huy hiệu menu) mà mỗi nơi gọi `useQuery` thì sau
 * vài giây đầu sẽ có ba đồng hồ cùng chạy trên một khoá — "một request" chỉ còn đúng ở lần mount,
 * và cả mục tiêu của thay đổi này tan trong im lặng.
 *
