 ...
 *
 * Bản native của `apps/web/src/components/shop/shop-highlight.ts`. Hai bản phải cho cùng một
 * câu với cùng một gian hàng: đây là một LỜI KHẲNG ĐỊNH về người bán, và web nói "Chủ xe 4.9
 * sao" trong khi app nói "Chủ xe mới" là hai lý lịch cho một người. Ngưỡng ở dưới là hợp đồng
 * giữa hai bản, sửa một bên phải sửa cả hai (ADR 0031 — không có cơ chế tự đồng bộ).
 *
