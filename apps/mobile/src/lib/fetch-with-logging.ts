 ...
 *
 * CHỈ ghi metadata. Không header, không body, không response — `Authorization` mang access token,
 * body đăng nhập mang mật khẩu, và response đăng nhập mang refresh token. Cả ba đều không được
 * xuống logcat/Console.app (ADR 0017). Cần xem body thì dùng Postman hoặc Flipper, đừng nới hàm này.
 */
