 ...
 * liệu cần chính xác.
 *
 * Bản native của `apps/web/src/lib/rounded-count.ts` — cùng bậc làm tròn, vì cùng một gian hàng
 * phải hiện cùng một con số ở hai bề mặt (ADR 0031: hai bản KHÔNG tự đồng bộ).
 *
