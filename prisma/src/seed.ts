...
const DEMO_VEHICLES: readonly DemoVehicle[] = [
  ...
  },
  {
    ...
    delivery: true,
    discount: 8,
    features: ['camera_360', 'sunroof', 'etc', 'screen', 'airbag', 'bluetooth'],
    img: photo('1553440569-bcc63803a83d'),
    gallery: [photo('1492144534655-ae79c964c9d7'), photo('1549399542-7e3f8b79c341')],
    desc: 'CUV hybrid tiết kiệm nhiên liệu, gầm cao dễ lái và đầy đủ công nghệ an toàn cho gia đình.',
    approved: true,
  },
  {
    code: 'XE-016',
    ...
    delivery: true,
    noCollateral: true,
    features: ['sunroof', 'backup_camera', 'reverse_sensor', 'screen', 'airbag', 'child_seat'],
    img: photo('1549399542-7e3f8b79c341'),
    gallery: [photo('1536700503339-1e4b06520771'), photo('1504215680853-026ed2a45def')],
    desc: 'SUV 7 chỗ linh hoạt, khoang xe rộng và vận hành êm; phù hợp chuyến đi gia đình dài ngày.',
    approved: true,
  },
  {
    code: 'XE-017',
    ...
    gallery: [photo('1502877338535-766e1452684a'), photo('1511919884226-fd3cad34687c')],
    desc: 'Sedan đời mới, tiết kiệm xăng và cốp rộng; lựa chọn phù hợp cho công tác hoặc du lịch ngắn ngày.',
    approved: true,
  },
  {
    code: 'XE-018',
    ...
    hourly: 105_000,
    noCollateral: true,
    features: ['sunroof', 'bluetooth', 'backup_camera', 'screen', 'airbag', 'etc'],
    img: photo('1504215680853-026ed2a45def'),
    gallery: [photo('1542362567-b07e54358753'), photo('1494976388531-d1058494cdd8')],
    desc: 'Sedan phong cách thể thao, nội thất tiện nghi và không gian thoải mái cho năm người lớn.',
    approved: true,
  },
  {
    code: 'XE-019',
    ...
    weekend: 1_850_000,
    delivery: true,
    features: ['camera_360', 'sunroof', 'etc', 'screen', 'airbag', 'child_seat'],
    img: photo('1494976388531-d1058494cdd8'),
    gallery: [photo('1549317661-bd32c8ce0db2'), photo('1568605117036-5fe5e7bab0b7')],
    desc: 'SUV 7 chỗ cao cấp, cabin yên tĩnh và nhiều công nghệ hỗ trợ lái cho hành trình đường dài.',
    approved: true,
  },
  {
    code: 'XE-020',
    ...
    hourly: 230_000,
    delivery: true,
    features: ['camera_360', 'dash_camera', 'gps', 'etc', 'spare_tire', 'airbag'],
    img: photo('1571068316344-75bc76f77890'),
    gallery: [photo('1568605117036-5fe5e7bab0b7'), photo('1570125909232-eb263c188f7e')],
    desc: 'SUV máy dầu mạnh mẽ, gầm cao và khoang hành lý lớn; phù hợp cung đường đèo hoặc đi tỉnh.',
    approved: true,
  },
  {
    code: 'XE-021',
    ...
    delivery: true,
    discount: 7,
    features: ['backup_camera', 'reverse_sensor', 'screen', 'airbag', 'child_seat', 'usb'],
    img: photo('1568605117036-5fe5e7bab0b7'),
    gallery: [photo('1519641471654-76ce0107ad1b'), photo('1550355291-bbee04a92027')],
    desc: 'SUV 7 chỗ thực dụng, hàng ghế gập linh hoạt và mức tiêu hao nhiên liệu hợp lý.',
    approved: true,
  },
  {
    code: 'XE-022',
    ...
    features: ['camera_360', 'dash_camera', 'gps', 'etc', 'spare_tire', 'airbag'],
    img: photo('1549399542-7e3f8b79c341'),
    gallery: [photo('1571068316344-75bc76f77890'), photo('1568605117036-5fe5e7bab0b7')],
    desc: 'SUV khung gầm chắc chắn, máy dầu bền bỉ; thích hợp chở gia đình và hành lý trên đường dài.',
    approved: true,
  },
  {
    code: 'XE-023',
    ...
    hourly: 165_000,
    delivery: true,
    features: ['camera_360', 'sunroof', 'bluetooth', 'screen', 'airbag', 'map'],
    img: photo('1553440569-bcc63803a83d'),
    gallery: [photo('1503376780353-7e6692767b70'), photo('1494976388531-d1058494cdd8')],
    desc: 'CUV thiết kế hiện đại, nhiều hỗ trợ an toàn và không gian hàng ghế sau rộng rãi.',
    approved: true,
  },
  {
    code: 'XE-024',
    ...
    discount: 10,
    noCollateral: true,
    features: ['bluetooth', 'backup_camera', 'screen', 'usb', 'airbag'],
    img: photo('1503376780353-7e6692767b70'),
    gallery: [photo('1536700503339-1e4b06520771'), photo('1549317661-bd32c8ce0db2')],
    desc: 'CUV nhỏ gọn, khoảng sáng gầm tốt và dễ xoay trở trong phố; phù hợp nhóm bốn đến năm người.',
    approved: true,
  },
  {
    code: 'XE-025',
    ...
    delivery: true,
    noCollateral: true,
    features: ['camera_360', 'gps', 'map', 'screen', 'airbag', 'etc'],
    img: photo('1617788138017-80ad40651399'),
    gallery: [photo('1553440569-bcc63803a83d'), photo('1504215680853-026ed2a45def')],
    desc: 'SUV điện tăng tốc mượt, cabin rộng và màn hình trung tâm lớn; có hướng dẫn sạc khi nhận xe.',
    approved: true,
  },
  {
    code: 'XE-026',
    name: 'VinFast VF 5 Plus 2024',
    plate: '51K-926.37',
    type: VEHICLE_TYPE.CAR,
    seats: 5,
    brand: 'vinfast',
    ...
    delivery: true,
    discount: 12,
    features: ['gps', 'map', 'screen', 'backup_camera', 'usb', 'airbag'],
    img: photo('1617788138017-80ad40651399'),
    gallery: [photo('1502877338535-766e1452684a'), photo('1511919884226-fd3cad34687c')],
    desc: 'Xe điện đô thị nhỏ gọn, chi phí vận hành thấp và phù hợp di chuyển hằng ngày trong thành phố.',
    approved: true,
  },
  {
    code: 'XE-027',
    ...
    weekend: 1_600_000,
    delivery: true,
    features: ['camera_360', 'screen', 'child_seat', 'airbag', 'bluetooth', 'etc'],
    img: photo('1519641471654-76ce0107ad1b'),
    gallery: [photo('1570125909232-eb263c188f7e'), photo('1549399542-7e3f8b79c341')],
    desc: 'MPV hybrid bảy chỗ, sàn phẳng và khoang hành khách thoáng; phù hợp gia đình nhiều thế hệ.',
    approved: true,
  },
  {
    code: 'XE-028',
    ...
    features: ['backup_camera', 'reverse_sensor', 'screen', 'airbag', 'child_seat', 'usb'],
    img: photo('1519641471654-76ce0107ad1b'),
    gallery: [photo('1542362567-b07e54358753'), photo('1550355291-bbee04a92027')],
    desc: 'MPV bảy chỗ nhỏ gọn, điều hoà cho hàng ghế sau và nhiều tính năng an toàn chủ động.',
    approved: true,
  },
  {
    code: 'XE-029',
    ...
    features: ['bluetooth', 'backup_camera', 'usb', 'screen', 'airbag'],
    img: photo('1542362567-b07e54358753'),
    gallery: [photo('1549317661-bd32c8ce0db2'), photo('1511919884226-fd3cad34687c')],
    desc: 'Sedan nhỏ dễ lái, vô lăng nhẹ và tiết kiệm nhiên liệu; hợp khách cần xe đi phố.',
    approved: true,
  },
  {
    code: 'XE-030',
    ...
    hourly: 165_000,
    delivery: true,
    features: ['camera_360', 'sunroof', 'screen', 'gps', 'airbag', 'etc'],
    img: photo('1553440569-bcc63803a83d'),
    gallery: [photo('1571068316344-75bc76f77890'), photo('1503376780353-7e6692767b70')],
    desc: 'CUV năm chỗ rộng rãi, màn hình kép và cửa sổ trời toàn cảnh; phù hợp cả phố lẫn cao tốc.',
    approved: true,
  },
  {
    code: 'XE-031',
    ...
    hourly: 75_000,
    noCollateral: true,
    features: ['backup_camera', 'bluetooth', 'usb', 'airbag'],
    img: photo('1536700503339-1e4b06520771'),
    gallery: [photo('1502877338535-766e1452684a'), photo('1533473359331-0135ef1b58bf')],
    desc: 'Sedan tiết kiệm, bán kính quay đầu nhỏ và khoang hành lý rộng; thủ tục thuê đơn giản.',
    approved: true,
  },
  {
    code: 'XE-032',
    ...
    delivery: true,
    discount: 6,
    features: ['backup_camera', 'screen', 'child_seat', 'bluetooth', 'usb', 'airbag'],
    img: photo('1519641471654-76ce0107ad1b'),
    gallery: [photo('1570125909232-eb263c188f7e'), photo('1568605117036-5fe5e7bab0b7')],
    desc: 'MPV bảy chỗ hiện đại, nhiều hộc để đồ và hàng ghế linh hoạt cho chuyến đi đông người.',
    approved: true,
  },
  {
    code: 'XE-033',
    ...
    features: ['camera_360', 'sunroof', 'etc', 'screen', 'airbag', 'child_seat'],
    img: photo('1568605117036-5fe5e7bab0b7'),
    gallery: [photo('1549399542-7e3f8b79c341'), photo('1494976388531-d1058494cdd8')],
    desc: 'SUV bảy chỗ cao cấp, động cơ dầu khoẻ và nhiều chế độ lái cho các điều kiện đường khác nhau.',
    approved: true,
  },
  {
    code: 'XE-034',
    ...
    img: photo('1550355291-bbee04a92027'),
    gallery: [photo('1542362567-b07e54358753'), photo('1549317661-bd32c8ce0db2')],
    desc: 'Sedan hạng D lịch sự, cabin yên tĩnh và hệ truyền động hybrid phù hợp gặp đối tác hoặc đi công tác.',
    approved: true,
  },
  {
    code: 'XM-001',
  ...
  },
  {
    ...
    gallery: [photo('1558981359-219d6364c9c8'), photo('1568772585407-9361f9bf3a87')],
    desc: 'Tay ga thể thao 160cc, khoá thông minh và phanh ABS; kèm hai mũ bảo hiểm đạt chuẩn.',
    approved: true,
  },
  {
    code: 'XM-005',
    name: 'Yamaha NVX 155 2023',
    plate: '59X1-515.26',
    type: VEHICLE_TYPE.MOTORBIKE,
    seats: 2,
    brand: 'yamaha',
    ...
    gallery: [photo('1558980664-10ea292d6d12'), photo('1599819811279-d5ad9cccf838')],
    desc: 'Xe tay ga 155cc mạnh mẽ, tư thế ngồi thoải mái và cốp lớn; phù hợp cả đi phố lẫn đi xa.',
    approved: true,
  },
  {
    code: 'XM-006',
    ...
    discount: 5,
    features: ['usb'],
    img: photo('1558981359-219d6364c9c8'),
    gallery: [photo('1558981403-c5f9899a28bc'), photo('1609630875171-b1321377ee65')],
    desc: 'Xe tay ga cốp rất rộng, sàn để chân thoải mái và tiết kiệm xăng; phù hợp đi lại hằng ngày.',
    approved: true,
  },
  {
    code: 'XM-007',
    ...
    gallery: [photo('1558981806-ec527fa84c39'), photo('1558980664-10ea292d6d12')],
    desc: 'Tay ga hybrid thanh lịch, trọng lượng nhẹ và vận hành êm; có cổng sạc điện thoại tiện dụng.',
    approved: true,
  },
  {
    code: 'XM-008',
    name: 'Honda Wave Alpha 2022',
    plate: '59X1-848.59',
    type: VEHICLE_TYPE.MOTORBIKE,
    seats: 2,
    brand: 'honda',
    ...
    discount: 8,
    features: ['gps'],
    img: photo('1558980664-10ea292d6d12'),
    gallery: [photo('1558981403-c5f9899a28bc'), photo('1599819811279-d5ad9cccf838')],
    desc: 'Xe số bền bỉ, dễ điều khiển và cực kỳ tiết kiệm nhiên liệu; phù hợp thuê dài ngày.',
    approved: true,
  },
  {
    code: 'XM-009',
    name: 'Yamaha Sirius 2022',
    plate: '59X1-959.60',
    type: VEHICLE_TYPE.MOTORBIKE,
    seats: 2,
    brand: 'yamaha',
    ...
    gallery: [photo('1568772585407-9361f9bf3a87'), photo('1558981359-219d6364c9c8')],
    desc: 'Xe số nhỏ gọn, máy khoẻ và dễ sửa chữa; thích hợp khám phá thành phố hoặc khu vực ngoại ô.',
    approved: true,
  },
  {
    code: 'XM-010',
    name: 'Honda Winner X 2023',
    plate: '59X1-070.71',
    type: VEHICLE_TYPE.MOTORBIKE,
    seats: 2,
    brand: 'honda',
    ...
    features: ['gps', 'usb'],
    img: photo('1558981806-ec527fa84c39'),
    gallery: [photo('1609630875171-b1321377ee65'), photo('1558980664-10ea292d6d12')],
    desc: 'Xe côn tay 150cc có ABS, vận hành ổn định và tư thế lái thể thao; giao xe kèm hướng dẫn sử dụng.',
    approved: true,
  },
  {
    code: 'XM-011',
    name: 'Yamaha Exciter 155 2023',
    plate: '59X1-181.82',
    type: VEHICLE_TYPE.MOTORBIKE,
    seats: 2,
    brand: 'yamaha',
    ...
    features: ['gps', 'usb'],
    img: photo('1568772585407-9361f9bf3a87'),
    gallery: [photo('1599819811279-d5ad9cccf838'), photo('1558981806-ec527fa84c39')],
    desc: 'Côn tay 155cc linh hoạt, sang số mượt và phù hợp khách đã quen xe thể thao đường phố.',
    approved: true,
  },
  {
    code: 'XM-012',
    ...
    img: photo('1609630875171-b1321377ee65'),
    gallery: [photo('1558981359-219d6364c9c8'), photo('1568772585407-9361f9bf3a87')],
    desc: 'Tay ga cao cấp 160cc, yên rộng và tư thế ngồi thư giãn; lý tưởng cho hành trình dài.',
    approved: true,
  },
  {
    code: 'XM-013',
    ...
    img: photo('1558981403-c5f9899a28bc'),
    gallery: [photo('1558980664-10ea292d6d12'), photo('1599819811279-d5ad9cccf838')],
    desc: 'Xe máy điện vận hành êm và không phát thải; bàn giao đầy pin cùng bộ sạc theo xe.',
    approved: true,
  },
] as const;
